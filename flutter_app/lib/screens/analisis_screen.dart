...
class _AnalisisScreenState extends State<AnalisisScreen> {
  ...
  Future<void> _seleccionarImagen() async {
    ...
    final reader = html.FileReader()..readAsArrayBuffer(input.files![0]);
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: const Text('No se pudo conectar con el servidor. Verifica tu conexión.'),
            ...
            if (_imagenSeleccionada && !_resultadoListo) ...[
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_analizando ? 'Analizando con IA...' : 'ANALIZAR IMAGEN',
...
// ── Extensión para ordenar entradas del mapa ───────────────────────────────
